...
class EmailTemplateGroup {
    ...
    static $all_groups = array(
        ...
        'ticket.user' => 'End-User Workorder Templates',
        'ticket.staff' => 'Staff Workorder Templates',
    );
    static $all_names=array(
        'ticket.autoresp'=>array(
            'group'=>'ticket.user',
            'name'=>'New Workorder Auto-response',
            'desc'=>'Autoresponse sent to user, if enabled, on new workorder.'),
        'ticket.autoreply'=>array(
            'group'=>'ticket.user',
            'name'=>'New Workorder Auto-reply',
            'desc'=>'Canned Auto-reply sent to user on new workorder, based on filter matches. Overwrites "normal" auto-response.'),
        'message.autoresp'=>array(
            'group'=>'ticket.user',
            'name'=>'New Message Auto-response',
            'desc'=>'Confirmation sent to user when a new message is appended to an existing workorder.'),
        'ticket.notice'=>array(
            'group'=>'ticket.user',
            'name'=>'New Workorder Notice',
            'desc'=>'Notice sent to user, if enabled, on new workorder created by staff on their behalf (e.g phone calls).'),
        'ticket.overlimit'=>array(
            'group'=>'ticket.user',
            'name'=>'Over Limit Notice',
            'desc'=>'A one-time notice sent, if enabled, when user has reached the maximum allowed open workorders.'),
        'ticket.reply'=>array(
            'group'=>'ticket.user',
            'name'=>'Response/Reply Template',
            'desc'=>'Template used on workorder response/reply'),
        'ticket.alert'=>array(
            'group'=>'ticket.staff',
            'name'=>'New Workorder Alert',
            'desc'=>'Alert sent to staff, if enabled, on new workorder.'),
        'message.alert'=>array(
            'group'=>'ticket.staff',
            'name'=>'New Message Alert',
            'desc'=>'Alert sent to staff, if enabled, when user replies to an existing workorder.'),
        'note.alert'=>array(
            'group'=>'ticket.staff',
        ...
        'assigned.alert'=>array(
            'group'=>'ticket.staff',
            'name'=>'Workorder Assignment Alert',
            'desc'=>'Alert sent to staff on workorder assignment.'),
        'transfer.alert'=>array(
            'group'=>'ticket.staff',
            'name'=>'Workorder Transfer Alert',
            'desc'=>'Alert sent to staff on workorder transfer.'),
        'ticket.overdue'=>array(
            'group'=>'ticket.staff',
            'name'=>'Overdue Workorder Alert',
            'desc'=>'Alert sent to staff on stale or overdue workorders.'),
        'staff.pwreset' => array(
            'group'=>'sys',
